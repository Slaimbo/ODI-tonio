 ...
 */
class Lieu extends \AppBundle\Entity\Lieu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Lieu' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Lieu' . "\0" . 'longitude', '' . "\0" . 'AppBundle\\Entity\\Lieu' . "\0" . 'latitude', '' . "\0" . 'AppBundle\\Entity\\Lieu' . "\0" . 'dateajout', '' . "\0" . 'AppBundle\\Entity\\Lieu' . "\0" . 'supprime'];
        }
