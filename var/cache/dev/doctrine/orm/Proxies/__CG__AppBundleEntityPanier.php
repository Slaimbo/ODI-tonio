...
class Panier extends \AppBundle\Entity\Panier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'numpanier', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'etat', '' . "\0" . 'AppBundle\\Entity\\Panier' . "\0" . 'login'];
        }
    ...
    public function getNumpanier()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getNumpanier();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumpanier', []);

        return parent::getNumpanier();
    }
